...
class HomePage(PageSetting):
    ...
    def __init__(self, parent):
        ...
        self.button.config(height="2", width="30", font=("helvetica", 20, "bold"),
                           bg="#e4643a", fg="#ffffff",
...
class QuizPage(PageSetting):
    ...
    def __init__(self, parent):
        ...
        self.question_label = Label(self, text="", font=("helvetica", 20, "bold"),
                                    wraplength=600)
        self.question_label.place(relx=0.5, rely=0.15, anchor="sw")
    ...
    def next_question(self):
        ...
        if self.selected.get() == q_data["answer"]:
            score += 1
            self.feedback_text.config(text="Correct! +1 point!", fg="#51fc5c")
        else:
